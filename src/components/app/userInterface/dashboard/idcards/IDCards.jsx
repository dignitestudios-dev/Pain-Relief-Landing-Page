            ...
            >
              ...
              <div className="px-2">
                ...
                <p className="text-sm text-gray-700">
                  ...
                  Please collect discounted payment when service is rendered or
                  make financial arrangements with the patient according to your
                  policies.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-l flex items-center flex-col justify-center to-[#63CFAC] from-[#29ABE2] rounded-b-md text-white text-center p-2 mt-3 min-h-[77.19px] sm:h-[77.19px]">
                ...
                <p className="text-xs sm:text-xs text-[10px]">
                  Cardholder is responsible for all applicable payments at point
                  of service.
                </p>
              </div>
            </div>
