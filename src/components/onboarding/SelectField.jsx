  ...
  return (
    ...
    >
      <div className="flex items-center">
        <div className="border-[1px] bg-gradient-to-l to-[#63CFAC] from-[#29ABE2]  border-[#D9D9D9] rounded-[12px] w-[40px] h-[40px] flex justify-center items-center ">
          <img src={icon} className="object-cover w-[22.74pxpx] h-[22.26px] " />
        </div>
