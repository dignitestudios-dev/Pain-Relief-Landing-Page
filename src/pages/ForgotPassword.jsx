    ...
    <div className="grid lg:grid-cols-2 grid-cols-1 w-full">
      ...
      <div className="flex flex-col justify-center items-center lg:h-auto h-screen">
        <div className="pb-4 text-center">
          ...
          <p className="text-[32px] font-bold capitalize">Forgot Password </p>
        ...
        <button className="bg-[#29ABE2] text-white lg:w-[350px] md:w-[550px] w-[350px] h-[48px] rounded-[8px] mt-6">
          Send
        </button>
        <button
          type="button"
